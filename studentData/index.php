              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="left-image">
                    <img src="assets/images/more-inf.jpg" alt="">
                  </div>
                </div>
                <div class="col-md-6 align-self-center">
                  <div class="right-content">

                    <h2>We are improving  <em>tut student transport</em></h2>
                    <p>Students are advised to use this application<br><br>to access tut transport</p>
